        ...
        >
          <ul className="space-y-1.5">
            ...
            <li className="hs-accordion" id="account-accordion">
              <p className="hs-accordion-toggle flex items-center gap-x-3.5 py-2 px-2 hs-accordion-active:text-white hs-accordion-active:hover:bg-transparent text-sm text-white hover:text-white rounded-md hover:bg-[#C1224F] cursor-pointer">
                <svg
                  className="w-3.5 h-3.5"
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
              ...
              >
                <ul className="pt-2 pl-7">
                  <li>
                    <p
                      onClick={() => navigate("/admin-hackathonGroups")}
                      className="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-white hover:text-white rounded-md hover:bg-[#C1224F] cursor-pointer"
                    >
                      <svg
                        className="w-3.5 h-3.5"
