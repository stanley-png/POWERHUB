  ...
  return (
    <main className="">
      ...
      <div
        ...
        className="hs-overlay hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform hidden fixed top-0 left-0 bottom-0 z-[60] w-64 bg-[#13ABC4] pt-7 pb-10 overflow-y-auto scrollbar-y lg:block lg:translate-x-0 lg:right-auto lg:bottom-0"
      >
        <div className="px-6">
          <p
            className="flex-none text-xl font-bold text-white cursor-pointer"
        ...
        >
          <ul className="space-y-1.5">
            <li>
              <p
                className="flex items-center gap-x-3 py-2 px-2.5 bg-[#C1224F] text-sm text-white rounded-md cursor-pointer"
                onClick={() => navigate("/admin")}
              >
                <svg
            ...
            <li className="hs-accordion" id="projects-accordion">
              <a
                className="hs-accordion-toggle flex items-center gap-x-3.5 py-2 px-2.5 hs-accordion-active:text-white hs-accordion-active:hover:bg-transparent text-sm text-white hover:text-white rounded-md hover:bg-[#C1224F]"
                href="javascript:;"
              >
                <svg
                  className="w-3.5 h-3.5"
                ...
                Pitch Decks
                <svg
                  className="hs-accordion-active:block ml-auto hidden w-3 h-3 text-white group-hover:text-white"
                  width="16"
                  height="16"
                  viewBox="0 0 16 16"
                  fill="none"
                ...
                <ul className="pt-2 pl-7">
                  ...
                  <li>
                    <a
                      ...
                      className="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-white hover:text-white rounded-md bg-[#c9315c] hover:bg-[#C1224F] cursor-pointer"
                    >
                      Add Project
                    </a>
                  </li>
