      ...
      <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
          ...
          <p class="mt-1 text-gray-600 dark:text-gray-400">
            See how game-changing projects are making the most of every
            engagement from our learners.
          </p>
        </div>
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            <div class="aspect-w-16 aspect-h-11">
              <img
                ...
                src="https://builtin.com/sites/www.builtin.com/files/styles/og/public/2022-08/connected-devices-internet-of-things-iot-devices.png"
                alt="Image Description"
              />
            </div>
            <div class="my-6">
              <h3 class="text-xl font-semibold text-gray-800 dark:text-gray-300 dark:group-hover:text-white">
                Scalling IOT in Africa
              </h3>
          ...
          >
            <div class="aspect-w-16 aspect-h-11">
              <img
                class="w-full object-cover rounded-xl"
                src="https://appinventiv.com/wp-content/uploads/sites/1/2022/07/How-Can-Your-Business-Benefit-From-The-Merger-Of-The-Cloud-And-IoT-01-scaled.webp"
                alt="Image Description"
              />
            </div>
            <div class="my-6">
              ...
              <p class="mt-5 text-gray-600 dark:text-gray-400">
                Looking to scale your presence online with cloud computing?.
              </p>
            </div>
            <div class="mt-auto flex items-center gap-x-3">
              <img
