    ...
    <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      <div className="max-w-2xl lg:max-w-5xl mx-auto">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-[#C1224F] sm:text-4xl">
            Contact us
          </h1>
              ...
              <div className="grid gap-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="py-3 px-4 block w-full border-[#13ABC4] border rounded-md text-sm focus:border-blue-500 focus:ring-blue-500"
                ...
                <div>
                  ...
                  <input
                    ...
                    className="py-3 px-4 block w-full border-[#13ABC4] border rounded-md text-sm focus:border-blue-500 "
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="py-3 px-4 block w-full border-[#13ABC4] border rounded-md text-sm "
                    placeholder="Message"
                  ></textarea>
                </div>
              </div>
